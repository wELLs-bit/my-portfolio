...
const portfolioSections = [
  {
    ...
    works: createWorks(
      [
        "Akosiwa Skincare",
        "Akosiwa Petroleum Jelly",
        "Akosiwa",
        "Akosiwa Teeth Whitener",
        // "Skin Care Campaign",
        // "Bottle Mockup Promo",
...

  {
    ...
    works: createWorks(
      [
        "HAVEN WEAR POSTER DESIGN",
        "WELLS POSTER DESIGN",
        "HOLY-DAVID POSTER DESIGN",
        "JENTECH AI POSTER DESIGN",
        "HOLY-DAVID POSTER DESIGN",
        "POSTER DESIGN",
        "ROAMING TRAVELS POSTER DESIGN",
        "ROAMING TRAVELS POSTER DESIGN",
      ],
      "Bonus Design",
      "Bonus Flyer",
